...
- Selected: 10
- Rejected: 10
- Materially different demo architectures: 10
- Required project folders: 10
...
## MDA readiness
The pre-send score is 2/10. Sending remains locked because the connected Gmail display name and domain do not match the approved identity, authentication is not verified, website identity is inconsistent and reputation status is unavailable.

## Rejected candidates
- **Regional Lightning Protection Limited** — Strong modern enquiry-focused site; smaller incremental opportunity than Strike Control.
- **G&S Steeplejacks Ltd** — Operating evidence found, but current corporate registry/contact verification was weaker in this run.
- **DIS Sprinklers Ltd** — Relevant but less distinctive journey opportunity than Automatic Sprinkler Solutions.
- **First Fire Protection Ltd** — Current site already communicates design, installation, maintenance and accreditation clearly.
- **Abelglass Trade Supplies Ltd** — Existing commercial project content and brochures reduce the immediate redesign opportunity.
- **Asbestos Surveying & Monitoring Ltd** — Already has detailed service-specific content, multiple location routes and urgent support messaging.
- **OHEC UK Ltd** — Strong niche fit, but the selected batch had better verified contact and routing opportunities.
- **Grease Tech Ltd** — Existing free survey and service messaging is comparatively strong; contact domain differs from site brand.
